          ...
          <div className={`px-8 pb-8 ${footerClassName}`}>
            ...
            >
              ...
              <button
                ...
                className="bg-primary-green-400 hover:bg-primary-green-500 active:bg-primary-green-600 flex items-center justify-center rounded-full px-3.5 py-1.5 font-medium tracking-tight text-white transition duration-350"
                {...nextButtonProps}
              >
    ...
    >
      <motion.div
        variants={{
          ...
          active: { scale: 1, backgroundColor: "#6b9080", color: "#5227FF" },
          complete: { scale: 1, backgroundColor: "#6b9080", color: "#3b82f6" },
        }}
...
function StepConnector({ isComplete }: StepConnectorProps) {
  const lineVariants: Variants = {
    ...
    complete: { width: "100%", backgroundColor: "#94b4a5" },
  };
